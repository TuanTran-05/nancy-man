...
for required in package.json package-lock.json node_modules/better-sqlite3/package.json dist/web/index.html dist/server/web-server.js dist/server/web-entry.js dist/server/collector-main.js dist/server/collector-entry.js dist/server/failsafe-main.js dist/server/failsafe-entry.js dist/server/provision-ops-user.js dist/server/smoke-beszel.js; do
